...
public class StreamSample {
	...
	public static void terminalOper() {
		...
		Integer intOptional2 = numbers.reduce(2,(i,j) -> {return i*j;});
	...
	/**
	 * 1.If you are using parallel stream and lambda expressions are stateful, it can result in random responses
	 * 2.Once a Stream is consumed, it can’t be used later on. As you can see in above examples 
	 *   that every time I am creating a stream.
	 */
	...
	public static List<Integer> buildList() {
		...
		for (int i=1; i < 10; i++) {
			...
			if (ii > 10) System.out.println("ii== " + ii);
			list.add(ii);
		}
		return list;
	}
